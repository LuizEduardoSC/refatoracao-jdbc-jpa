...
import br.com.eduardo.dao.generic.GenericDAO;
...
public class ClienteDAO extends GenericDAO<Cliente, Long> implements IClienteDAO {
	...
	protected String getQueryAtualizacao() {
		...
		sb.append("SET NOME = ?, "); // Adicionei espaço/vírgula para segurança
		sb.append("TEL = ?, ");
		sb.append("ENDERECO = ?, ");
		sb.append("NUMERO = ?, ");
		sb.append("CIDADE = ?, ");
		sb.append("ESTADO = ? "); // Espaço aqui é vital!
		sb.append(" WHERE CPF = ? "); // Espaço antes do WHERE resolve o SOWHERE
		return sb.toString();
	}
